...
/**
 * JUnit tests for {@link DefaultHeartbeatAccuracyPower}.
 * 
 * @author Connor Imes
 */
public class DefaultHeartbeatAccuracyPowerTest {
	...
	public void test_normal() {
		...
		HeartbeatAccuracyPower hb = DefaultHeartbeatAccuracyPower.create(WINDOW_SIZE, fos);
