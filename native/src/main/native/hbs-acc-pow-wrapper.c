...
JNIEXPORT jobject JNICALL Java_edu_uchicago_cs_heartbeats_HeartbeatAccPowJNI_heartbeatAccPowInit(JNIEnv* env,
  ...
  if (heartbeat_acc_pow_init(hb, window_size, hbr, -1, NULL)) {
    free(hbr);
    free(hb);
    return NULL;
  }
 ...
 * Issue a heartbeat.
 */
JNIEXPORT void JNICALL Java_edu_uchicago_cs_heartbeats_HeartbeatAccPowJNI_heartbeatAccPow(JNIEnv* env,
                                                                                          jobject obj,
                                                                                          jobject ptr,
                                                                                          jlong user_tag,
                                                                                          jlong work,
